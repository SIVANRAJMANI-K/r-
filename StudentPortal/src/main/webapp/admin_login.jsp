...
<% 
out.println("<script>console.log('Request method: " + request.getMethod() + "');</script>");
...
try{
	...
	Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/Student","root","Siva");
